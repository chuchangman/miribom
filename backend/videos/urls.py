...
from .views import (
    VideoPresignedUrlView, ThumbnailPresignedUrlView, VideoUploadCompleteView, VideoView, VideoDetailView,
...
urlpatterns = [
    ...
    path('thumbnail-presigned-url/', ThumbnailPresignedUrlView.as_view(), name='thumbnail-presigned-url'),
